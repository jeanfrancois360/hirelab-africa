                                                    ...
                                                    <div className="utf-manage-resume-overview-aera-inner">
                                                        ...
                                                        <div className="utf-manage-resume-item">
                                                            ...
                                                            <div className="utf-buttons-to-right">
                                                                ...
                                                                <a href={`${ApiUrl}/file-upload/${application.user.cv.file}`} download target={'_blank'} className="button ripple-effect ico info-tb-btn-2" title="Download CV" data-tippy-placement="top" rel="noreferrer"><i className="icon-feather-download"></i></a>

									...
									<div className="utf-job-listing-details">
										...
										<div className="utf-job-listing-description">
											...
											<div className="utf-job-listing-footer">
												<ul>
													<li><i className="icon-feather-briefcase"></i> Graphic Designer</li>
								...
								<a href="single-job-page.html" className="utf-job-listing utf-apply-button-item">
									<div className="utf-job-listing-details">
										...
										<div className="utf-job-listing-description">
											...
											<div className="utf-job-listing-footer">
												<ul>
													<li><i className="icon-feather-briefcase"></i> UI/UX Designer</li>
													<li><i className="icon-material-outline-account-balance-wallet"></i> $35000-$38000</li>
													<li><i className="icon-material-outline-location-on"></i> Drive Potsdam, NY 676</li>
													<li><i className="icon-material-outline-access-time"></i> 25 Minute Ago</li>
												</ul>
											</div>
										</div>
										<span className="list-apply-button ripple-effect">Browse Job <i className="icon-line-awesome-bullhorn"></i></span>
										...
										<div className="utf-job-listing-description">
											...
											<div className="utf-job-listing-footer">
												<ul>
													...
													<li><i className="icon-material-outline-account-balance-wallet"></i> $35000-$38000</li>
													<li><i className="icon-material-outline-location-on"></i> Drive Potsdam, NY 676</li>
													<li><i className="icon-material-outline-access-time"></i> 38 Minute Ago</li>
												</ul>
											</div>
										</div>
										<span className="list-apply-button ripple-effect">Browse Job <i className="icon-line-awesome-bullhorn"></i></span>
								...
								<a href="single-job-page.html" className="utf-job-listing utf-apply-button-item">
									<div className="utf-job-listing-details">
										...
										<div className="utf-job-listing-description">
											...
											<div className="utf-job-listing-footer">
												<ul>
													<li><i className="icon-feather-briefcase"></i> Web Developer</li>
													<li><i className="icon-material-outline-account-balance-wallet"></i> $35000-$38000</li>
													<li><i className="icon-material-outline-location-on"></i> Drive Potsdam, NY 676</li>
								...
								<a href="single-job-page.html" className="utf-job-listing utf-apply-button-item">
									<div className="utf-job-listing-details">
										...
										<div className="utf-job-listing-description">
											...
											<div className="utf-job-listing-footer">
												<ul>
													<li><i className="icon-feather-briefcase"></i> Android Developer</li>
													<li><i className="icon-material-outline-account-balance-wallet"></i> $35000-$38000</li>
													<li><i className="icon-material-outline-location-on"></i> Drive Potsdam, NY 676</li>
								...
								<a href="single-job-page.html" className="utf-job-listing utf-apply-button-item">
									<div className="utf-job-listing-details">
										...
										<div className="utf-job-listing-description">
											...
											<div className="utf-job-listing-footer">
												<ul>
													<li><i className="icon-feather-briefcase"></i> IOS Developer</li>
													<li><i className="icon-material-outline-account-balance-wallet"></i> $35000-$38000</li>
													<li><i className="icon-material-outline-location-on"></i> Drive Potsdam, NY 676</li>
													<li><i className="icon-material-outline-access-time"></i> 1 Days Ago</li>
												</ul>

...
import { CreateBlogCategory } from '../api/blog-category'

export const AddBlogCategorySection: FC = () => {
    let initialValues = {
        name: '',
        status: 'Active',
    };
    ...
    // Mutation For Adding Blog Category
    const createMutation = useMutation(CreateBlogCategory);

    const handleAddCategory = async (payload: IBlogCategory) => {
        const newBlogCategory = await createMutation.mutateAsync(payload)
        if (newBlogCategory) {
    ...
    return (
        <>
            <ToastContainer />
            {/* < !--Header Container-- > */}
            <DashboardHeader current={'Add Blog Category'} />
            ...
            <div className="utf-dashboard-container-aera">
                ...
                <div className="utf-dashboard-content-container-aera" data-simplebar>
                    <DashboardTitlebar current={'Add Blog Category'} prev={'Dashboard'} url={'/dashboard'} />

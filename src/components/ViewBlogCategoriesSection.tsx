...
import { DeleteBlogCategory, GetBlogCategories, UpdateBlogCategory } from '../api/blog-category'
...
export const ViewBlogCategoriesSection: FC = () => {
    ...
    const { data: blog_categories, isLoading: isFetchingCategories, refetch: RefetchBlogCategories }: UseQueryResult<IBlogCategory[], Error> = useQuery<IBlogCategory[], Error>('blog-categories', GetBlogCategories);
    ...
    return (
        <>
            ...
            <div className="utf-dashboard-container-aera">
                {/* <!-- Dashboard Sidebar --> */}
                <SidebarSection current={'manage_blog_categories'} />
                                ...
                                <div className="utf_dashboard_list_box table-responsive recent_booking dashboard-box">
                                    <div className="headline">
                                        ...
                                        <div className="sort-by">
                                            <a href="/add-blog-category" className="button gray utf-ripple-effect-dark"><i className="icon-feather-plus"></i> Add category</a>
                                        </div>
                                    </div>
                                    <div className="dashboard-list-box table-responsive invoices with-icons">
                                        {blog_categories && blog_categories.length > 0 ? (<><table className="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                {blog_categories && blog_categories.map((category: any, index: number) =>
                                                (<tr key={category.id}>
                                                    <td>{index + 1}</td>
                                                    <td>
                                            ...
                                            <div className="utf-pagination-container-aera margin-top-20 margin-bottom-20">
                                                <nav className="pagination">
                                                    <ul>
                                                        <li className="utf-pagination-arrow"><a href="/view-blog-categories" className="ripple-effect"><i className="icon-material-outline-keyboard-arrow-left"></i></a></li>
                                                        <li><a href="/view-blog-categories" className="ripple-effect current-page">1</a></li>
                                                        <li className="utf-pagination-arrow"><a href="/view-blog-categories" className="ripple-effect"><i className="icon-material-outline-keyboard-arrow-right"></i></a></li>
                                                    </ul>
                                                </nav>
                                            </div>
                                            <div className="clearfix"></div>
